          ...
          <tbody className="--body_background divide-y divide-gray-200">
            {GroupData.map((person, index) => (
              ...
              >
                ...
                <td className="px-2 py-4 text-sm --body-color">{person.userName}</td>
                <td className="px-2 py-4 text-sm --body-color">{person.userEmail}</td>
                <td className="px-2 py-4 text-sm --body-color">{person.category}</td>
